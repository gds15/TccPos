...
<?php
    ...
    ?>          
                <div class="verAti">
                    ...
                    //se a nota n for empty vai por um botao que n da pra clicar pq o professor ja vai ter dado a nota e corrigido a atividade
                    ...
                    //forma simples de resolver aquele problema de ontem
                        if( !empty ($nota)) {
                            echo "<button type='button' class='btn btn-lg btn-primary' disabled>Editar</button>";
                        } else {
