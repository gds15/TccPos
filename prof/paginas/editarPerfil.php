				...
				<form class="validate-form" name="formEnvio" method="post" action="salvarPerfil" enctype="multipart/form-data" novalidate>
					...
					<fieldset>
                        ...
                        <div class="form-group col-md-12" id="pro">
							...
							<div class="controls validate-input" data-validate = "Informe o Email">
								<input required type="email" name="contato" class="form-control input100" id="contato" value='<?=$contato;?>'>
								<span class="focus-input100"></span>
							</div>
						</div>
