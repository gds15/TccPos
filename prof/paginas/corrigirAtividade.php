					...
					<fieldset>
						...
						<div class="form-group col-md-6 mb-3 " id="idAlu">
							...
							<div class="controls validate-input" data-validate = "Informe o id aluno">
								<input required type="text" name="aluno_id" class="form-control input100" id="aluno_id" readonly value="<?=$aluno_id?>">
						...
						<div class="form-group col-md-12" id="desc">
							...
							<div class="controls wrap-input100 validate-input" data-validate = "Informe a descricao">
								<input rows="8" class="form-control input-lg input100" placeholder="Descrição da Atividade" name="descricao" readonly value="<?=$descricao;?>" type="text">
								<span class="focus-input100"></span>
							</div>
						</div>
                        ...
                        <div class="form-group col-md-12" id="nota">
							<label for="nota">Nota:</label>
							<div class="controls wrap-input100 validate-input" data-validate = "Informe a nota">
								<input rows="8" class="form-control input-lg input100" placeholder="Nota da Atividade" name="nota"  value="<?=$nota;?>" type="text">
								<span class="focus-input100"></span>
							</div>
						</div>

                        <div class="form-group col-md-12" id="correcao">
							<label for="correcao">Correção:</label>
							<div class="controls wrap-input100 validate-input" data-validate = "Informe a correção">
								<input rows="8" class="form-control input-lg input100" placeholder="Correção" name="correcao"  value="<?=$correcao;?>" type="text">
								<span class="focus-input100"></span>
							</div>
						</div>
